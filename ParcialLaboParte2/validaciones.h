...
/** \brief Valida si un numero esta dentro del rango definido por el maximo y el minimo
 *
 ...
 *
 * \param int dia Recibe el dia ingresado
 * \param int mes Recibe el mes ingresado
 * \param int anio Recibe el año ingresado
 * \param int anioActual Recibe el año actual
 * \return Retorna 1 si la fecha es valida y si no corresponde a un año pasado, retorna 0 si la fecha es invalida
 *
 */
